...
| **Los avisos naranjas y rojos oficiales de AEMET de toda España se enseñan en Avisos y se avisan al móvil como información, tal cual los publica Meteoalarm; la primera pasada solo apunta, no avisa (17-09-2026, «cuando pase algo como lo de Valencia me gustaría saber», «es solo info», «España»)** | `el vigilante avisa al móvil de un naranja o rojo NUEVO, como no importante, al final de la pasada y con el fallo tragado` |
