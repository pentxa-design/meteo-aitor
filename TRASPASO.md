...
**Segunda verdad de la calle (10:35, camino de Balmaseda):** *«hacia Balmaseda y Sopuerta veo bastante despejado casi todo»*. Misma pasada de Meteosat (08:00Z): infrarrojo Sopuerta 33, Balmaseda 34, Güeñes 34 frente a Barakaldo 38 y Bermeo 40 (separa poco: la nube media no es muy fría); **visible** Sopuerta 102, Balmaseda 102, Güeñes 96, Vitoria 110 frente a **Barakaldo 145 y Bermeo 173** (separa bien de día). O sea: de día manda el visible, de noche solo queda el infrarrojo, y el umbral de cada uno hay que medirlo. Dos verdades de la calle en una mañana y el satélite acierta las dos donde tres de cuatro modelos fallan. El catálogo de `/satelite` iba 35 min por detrás (a las 10:35 la última pasada era la de las 10:00).

**Tercera verdad de la calle (10:40, Sodupe):** foto con cielo azul entero; Alonsotegi y Sodupe despejados. Cuadra con el visible del satélite (Güeñes 96). Su lectura, que es la buena: *«habrán pensado que iba a despejar antes»* — la nube baja de la costa se retira de dentro hacia fuera y los modelos (menos ICON) la tenían levantada ya a las 09:00-10:00 en Barakaldo y Bermeo. Es un fallo de HORA de los modelos, no de sitio; y por eso lo que hace falta para el «ahora» es una medida (satélite), no otro modelo.

### §37 · 26-09-2026, 00:43-01:05, iMac: LA NOTA DE LA FRANJA DICE LO QUE SE LEE (build 2026.09.26-0050)

**Su pantallazo de las 00:43:** franja Madrugada «Velo de nubes altas · cubierto desde las 02:00» y debajo, en ámbar, «Ha cambiado a las 23:09: antes velo de nubes altas». Suyo: *«¿si está igual, no?»*. El cambio era real (el tramo 2-5 h pasó de velo a cubierto, y a esa hora estaba nuboso), pero `cambioDeCielo()` comparaba el CÓDIGO de la franja entera y escribía un «antes» que era el principio del «ahora». Ahora guarda también el titular (`tituloFranja(sel, code)`, sin el sufijo de la lluvia) y la nota sale de lo que se lee: igual → nada; el antes es el principio del ahora → «antes solo velo de nubes altas»; distinto → «antes …» entero. Tres pruebas vistas en rojo antes del arreglo; la guarda del llamador actualizada. Banco 1343 (el portátil metió las suyas anoche). También: el aviso del vigilante de las 19:43 («no he podido mirar 11») fue una tanda de Open-Meteo caída en la pasada de las 19:01, en el build anterior; la de las 22:01 miró los 20. Pendiente: reintentar la tanda caída dentro de la misma pasada y un tiempo tope por petición.

### §38 · 26-09-2026, 20:00-20:30, iMac: EL SSD VUELVE DEL MACBOOK — comprobado lo del día, nada que reparar

**Lo que trajo el MacBook (once commits, 09:54-19:38, sin § aquí: las notas van en los cuerpos):** por qué le fallaban cuatro sitios a diario (la tanda se daba por perdida a la primera y los veinte salían a la vez: reintento y fin del atasco) y la cadencia a dos horas; la nota de la cadencia sin contradecir al código; lo que viene hoy en una línea y en rojo arriba; la cadencia se acelera sola SOLO en rojo y un segundo parte a las 13:00; la palabra de la tapa de un solo sitio y las pantallas comparadas entre sí; el mapa de ráfagas pintaba el rojo en su ámbar (70/90) y cuatro copias más; lo que quedaba del barrido de **cinco agentes** (el color que afirma lo que el texto niega); buscar un sitio en Mis estaciones te lleva al sitio. Publicado: **2026.09.26-1937** (local = web).

**Comprobado desde el iMac sobre ese build:** banco **1370 bien, 0 mal**; `pantallas.cjs` en verde a las cinco horas; `probar-avisos.sh` con la clave, 4/4 (en el MacBook ese paso no puede pasar); y la web a las 20:10 con Bermeo: día/noche de 48 h contra el orto, dibujos, «Mar de fondo 1,8» = current, chapas de 10 días y de Horas por su listón (70/90 hierro), sin NaN ni decimales con punto, «Máx 23° a las 15:00 · Mín 19° a las 07:00»; Mis estaciones con 20 sitios, 0 «midiendo», Almike (Euskalmet, 1,1 km, hace 16 min) y las dos redes en el pie, pista con 72 h miradas, «lo ve» donde toca, pestaña del parte = día enseñado, marcador sin «Cargando» ni «N veces». Vigilante vivo (pulso abajo). **Nada que reparar.**

**Órdenes suyas de esta tarde, para quien venga:** la cadencia del vigilante la fijó él con el MacBook (**«eso ni tocar»**: nada de avisos cada 10 minutos); la app se da por **terminada** en cuanto a funciones («para dejarlo ya finiquitada»): lo que queda es mantenimiento, el muestreo del satélite (§36, solo si él lo pide) y medir el gasto de Vercel cuando haya Chrome. Y una cosa de su móvil, no de la app: **DuraSpeed** restringía aplicaciones en segundo plano y el aviso de las 19:01 del 25-09 llegó 42 min tarde (`llegado − enviado`); dijo «cambios hechos».
